...
User.create!(first_name: 'Barack', last_name: 'Obama', username: 'barcdk.o', email: 'barack@mail.com', date_of_birth: '1990-12-10', gender: 'Male', phone: '151515151', address_line: "zyx zyx zyx")
User.create!(first_name: 'Jessica', last_name: 'Alba', username: 'jess.aflb', email: 'jess@mail.com', date_of_birth: '1990-12-10', gender: 'female', phone: '161616161', address_line: "zyx zyx zyx")
User.create!(first_name: 'Jessy', last_name: 'Fokoua', username: 'jess.af', email: 'jessy@mail.com', date_of_birth: '1990-12-10', gender: 'female', phone: '111111111', address_line: "xyz xyz xyz")
User.create!(first_name: 'Allpohon', last_name: 'Will', username: 'all.wihll', email: 'allpholon@mail.com', date_of_birth: '1990-12-10', gender: 'Male', phone: '121212121', address_line: "zyx zyx zyx")
User.create!(first_name: 'Mand', last_name: 'Zeux', username: 'mand.za', email: 'mand@mail.com', date_of_birth: '1990-12-10', gender: 'Male', phone: '131313131', address_line: "zyx zyx zyx")
User.create!(first_name: 'Illya', last_name: 'Rex', username: 'illy.hr', email: 'illya@mail.com', date_of_birth: '1990-12-10', gender: 'Male', phone: '141414141', address_line: "zyx zyx zyx")
User.create!(first_name: 'OLad', last_name: 'Well', username: 'olad.wy', email: 'olad@mail.com', date_of_birth: '1990-12-10', gender: 'Male', phone: '151515151', address_line: "zyx zyx zyx")
User.create!(first_name: 'Grider', last_name: 'Okid', username: 'grid.oe', email: 'grider@mail.com', date_of_birth: '1990-12-10', gender: 'Male', phone: '161616161', address_line: "zyx zyx zyx")
