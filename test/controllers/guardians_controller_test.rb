...
class GuardiansControllerTest < ActionController::TestCase
  ...
  test "should create guardian" do
    assert_difference('Guardian.count') do
      post :create, guardian: { email: @guardian.email, first_name: @guardian.first_name, last_name: @guardian.last_name, occupation: @guardian.occupation, phone: @guardian.phone, relation: @guardian.relation }
    end
  ...
  test "should update guardian" do
    patch :update, id: @guardian, guardian: { email: @guardian.email, first_name: @guardian.first_name, last_name: @guardian.last_name, occupation: @guardian.occupation, phone: @guardian.phone, relation: @guardian.relation }
    assert_redirected_to guardian_path(assigns(:guardian))
  end
